    ...
    <main className="bg-dark min-h-screen">
          ...
          <div className="max-w-md">
            ...
            <Reveal delay={0.4}>
              <p className="text-base md:text-lg text-text-light leading-relaxed">
                Each Dark Luxe bag is meticulously crafted with a focus on
                ethical production and timeless design. You don&apos;t just
                carry a beautiful bag—you carry a belief in a better, more
                responsible future.
              </p>
            </Reveal>
          </div>
            ...
            <div className="flex flex-col items-center text-center">
              <Reveal delay={0.5}>
                ...
                <p className="text-base text-text-muted leading-relaxed">
                  ...
                  supports local artisans and communities, ensuring dignity and
                  fair wages.
                </p>
              </Reveal>
            </div>
      ...
      <section className="flex flex-col md:flex-row-reverse min-h-screen">
        ...
        <div className="w-full md:w-1/2 min-h-[50vh] md:min-h-screen relative">
          <Reveal width="100%" className="h-full relative">
            <Image
              src="/products/Out/Landon bag/Tan/3.jpg"
              alt="Dark Luxe Product"
              fill
              className="object-cover"
              sizes="(max-width: 768px) 100vw, 50vw"
            />
          ...
          <div className="max-w-md">
            ...
            <Reveal delay={0.3}>
              <p className="text-base md:text-lg text-text-light leading-relaxed mb-8">
                When you choose Dark Luxe, you choose more than a bag. You
                choose a statement of style that aligns with your
                values—sustainability, elegance, and purpose.
              </p>
            </Reveal>
            <Reveal delay={0.4}>
              <Link
