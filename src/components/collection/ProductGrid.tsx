            ...
            {products.map((product, index) => (
                ...
                >
                    ...
                    <Link
                        ...
                        target="_blank"
                        className="absolute top-3 right-3 md:top-5 md:right-5 w-10 h-10 bg-gold/90 flex items-center justify-center opacity-100 md:opacity-0 md:-translate-y-1.5 md:transition-all md:duration-300 md:group-hover:opacity-100 md:group-hover:translate-y-0"
                    >
