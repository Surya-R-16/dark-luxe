        ...
        <section className="relative min-h-screen flex items-center justify-center bg-transparent overflow-hidden pt-20">
            ...
            <div className="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl leading-[1.1] mb-8 text-primary">
                        Pure <br />
                        Elegance <span className="text-accent-gold italic">Redefined</span>
                    </h1>
                    <p className="text-text-secondary text-lg md:text-xl max-w-lg mx-auto md:mx-0 mb-10 font-light leading-relaxed">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center md:justify-start">
                        <Link
                            ...
                            target="_blank"
                            className="px-8 py-4 bg-accent-gold text-white text-sm font-bold tracking-widest uppercase hover:bg-black transition-colors duration-300 text-center"
                        >
                            Shop on Amazon
                        </Link>
                        <Link
                            href="/products"
                            className="px-8 py-4 border border-primary/20 text-primary text-sm font-bold tracking-widest uppercase hover:border-accent-gold hover:text-accent-gold transition-colors duration-300 text-center"
                        >
                            View Collection
                        </Link>
                    </div>
                ...
                >
                    ...
                    <div className="relative w-full h-full">
                        <Image
                            src="/products/hero-white-gold.png"
                            alt="Pure Elegance White Gold Handbag"
                            fill
